...
import useStyles from "./MyAccountLoginCss";
...
export default function MyAccountLogin()
{
    ...
    const handleCheck = async() => {
        ...
        else
        {
            ...
            var otpMsg = "Verification: Hey Giftie..!!, "+otp+" is your One Time Password for mobile verification at Creative_Gifts_Villa."
            alert(otpMsg)
            //var body = {mobileno: mobileNo, otp: otp}
            //var result = await postData('customer/smsotp', body)
            navigate(`/accounts/register`, {state: {otp: otp, mobileno: mobileNo}})
            setLoading(false)
        }
    }
