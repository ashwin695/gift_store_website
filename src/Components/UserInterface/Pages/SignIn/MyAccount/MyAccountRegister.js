...
import useStyles from "./MyAccountRegisterCss";
            ...
            <Grid container spacing={1} className={classes.root}>
                <Grid item xs={9} sx={{ margin:'2% 0% 1% 0%'}}>
                    <Paper className={classes.paper} elevation={14} sx={{ borderRadius:8, padding:'3% 3% 3% 3%' }}>
                        <Grid item xs={12}>
                            <Close className={classes.icon} onClick={()=>navigate(`/accounts/login`)} />
                        </Grid>
                        ...
                        <Grid container spacing={1}>
                            ...
                            <Grid item xs={7.5} sx={{ margin:2, textAlign:'center' }}>
                                ...
                                <div style={{ display:'flex' }}>
                                    <Grid item xs={12} sx={{ margin:'0% 0% 1% 1.5%' }} className={classes.change} onClick={()=>navigate(`/login`)}>
                                        Change
                                    </Grid>
                                </div>
                                <div style={{ display:'flex' }}>
                                ...
                                <div style={{ display:'flex', margin:'0% 0% 0% 0%' }}>
                                    <Grid item xs={12} sx={{ margin:'0% 0% 1% 1.5%' }} className={classes.change} onClick={handleResendOTP}>
                                        Resend OTP
                                    </Grid>
                                </div>
