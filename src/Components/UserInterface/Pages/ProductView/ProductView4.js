...
export default function ProductView4(){
    ...
    const handleBuyNow = (item) => {
        if( sizeData.length > 0 )
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var body = { item, giftWrap, userWhatsapp, size, sizeId, color, price, offerprice, qty }
        ...
        else if( colorData.length > 0 )
        {
            ...
            else
            {
                ...
                {
                    /* var body = {item, giftWrap, userWhatsapp, size, sizeId, color, price, offerprice, uploadedFiles, filesWishMsg, filesName, filesMsg} */
                    var body = { item, giftWrap, userWhatsapp, size, sizeId, color, colorId, price1, offerprice1, qty }
                    dispatch({ type: 'Add_Products', payload: [item.productid, body]})
                    setRefresh(!refresh)
                    navigate(`/cart`)
                }  
