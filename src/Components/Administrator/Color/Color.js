...
export default function Color(props){
    ...
    const handleSubmit = async() => {
        var body = {colorname: colorName, categoryid: categoryId, subcategoryid: subcategoryId, productid: productId}
        var result = await postData('color/colorsubmit', body)
        if(result.result)
        {
            Swal.fire({
                position: 'center',
                ...
                <Grid container spacing={1}>
                    ...
                    <Grid item xs={6} className={classes.end}>
                        <Button 
                            ...
                            onClick={()=>props.setComponent(<DisplayAllColors setComponent={props.setComponent} />)}
                        >
                            <ListAlt />
                        </Button>
                    </Grid>
